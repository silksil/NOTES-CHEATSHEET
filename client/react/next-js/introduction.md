...
- It does the routing; there is no routing, there are pages. Every single page you want to visit those gonna be .js files. In those files you can create a React component.
